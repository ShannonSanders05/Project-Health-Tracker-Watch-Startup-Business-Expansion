...
COPY public.competitors (research_development_spent, administration, marketing_spent, state_usa, profit) FROM 'C:\Users\User\Documents\DATA ANALYST\SELF STUDY\FINAL TASK\final_task\3588.dat';
...
COPY public.corruption_convictions_per_capita (state_usa, convictions_per_capita) FROM 'C:\Users\User\Documents\DATA ANALYST\SELF STUDY\FINAL TASK\final_task\3591.dat';
...
COPY public.health_spending (state_usa, avg_spending, min_spending, max_spending) FROM 'C:\Users\User\Documents\DATA ANALYST\SELF STUDY\FINAL TASK\final_task\3589.dat';
...
COPY public.population (state_usa, estimate) FROM 'C:\Users\User\Documents\DATA ANALYST\SELF STUDY\FINAL TASK\final_task\3593.dat';
...
COPY public.property_prices (state_usa, avg_price, min_price, max_price) FROM 'C:\Users\User\Documents\DATA ANALYST\SELF STUDY\FINAL TASK\final_task\3590.dat';
...
COPY public.state_income (state_usa, average_income, minimum_income, maximum_income) FROM 'C:\Users\User\Documents\DATA ANALYST\SELF STUDY\FINAL TASK\final_task\3592.dat';
